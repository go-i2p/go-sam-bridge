...
require (
	...
	github.com/go-i2p/go-datagrams v0.1.70
	github.com/go-i2p/go-i2cp v0.1.60000-0.20260701134816-aa86eb2db4a5
	github.com/go-i2p/go-i2p v0.1.70
	github.com/go-i2p/go-streaming v0.1.70
...
require (
	...
	github.com/go-i2p/go-nat-listener v0.1.70 // indirect
