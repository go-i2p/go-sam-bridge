...
require (
	...
	github.com/go-i2p/go-datagrams v0.1.599
	github.com/go-i2p/go-i2cp v0.1.599
	github.com/go-i2p/go-i2p v0.1.599
	github.com/go-i2p/go-streaming v0.1.599
...
require (
	...
	github.com/go-i2p/go-noise v0.1.599 // indirect
	...
	github.com/go-i2p/su3 v0.1.599 // indirect
